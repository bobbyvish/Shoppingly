...
from django.contrib.auth.forms import UserCreationForm, AuthenticationForm, UsernameField, UsernameField, PasswordChangeForm, PasswordResetForm, SetPasswordForm
...
class MyPasswordChangeForm(PasswordChangeForm):
    ...
    new_password1 = forms.CharField(label=('New Password'), strip=False, widget=forms.PasswordInput(
        attrs={'autocomplete': 'new-password',  'class': 'form-control'}), help_text=password_validation.CommonPasswordValidator())
